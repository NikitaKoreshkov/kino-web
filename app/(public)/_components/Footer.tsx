...
export default function Footer({ lang: initialLang }: { lang?: "ru" | "en" }) {
  ...
  return (
    <footer className="footerSection" aria-label="Footer">
      <div className="footerGlow" aria-hidden />

      <div className="footerWrap footerMain">
        <div className="footerBrand">
          <div className="fBrandText">
            <div className="fName">SHOW SOCHI</div>
            <div className="fTag">
              {lang === "ru" ? "Место для ваших эмоций" : "Premium event space"}
            </div>
          </div>
        </div>
        ...
        <nav
          className="footerNav"
          aria-label={lang === "ru" ? "Навигация по сайту" : "Site navigation"}
        >
          <div className="fCol">
            ...
            <ul>
              ...
              <li>
                <a href="/about">{lang === "ru" ? "О нас" : "About"}</a>
              </li>
              <li>
                <a href="/#events">{lang === "ru" ? "События" : "Events"}</a>
              </li>
              <li>
                <a href="/shows/yupi">{lang === "ru" ? "Пенное шоу" : "Foam show"}</a>
              </li>
              <li>
                <a href="/shows/cinema">{lang === "ru" ? "Кино под звёздами" : "Cinema"}</a>
              </li>
              <li>
                <a href="/shows/master">{lang === "ru" ? "Мастер-класс" : "Master class"}</a>
              </li>
              <li>
                <a href="/booking">{lang === "ru" ? "Билеты" : "Tickets"}</a>
              </li>
            </ul>
          </div>
          <div className="fCol">
            ...
            <ul>
              <li>
                <a
                  href="https://yandex.ru/maps/org/shousochi/131805703222?si=xuveu79t4ej551g2etpf7ty3t8"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  {lang === "ru" ? "ул. Калинина, 1/1" : "Kalinin St, 1/1"}
                </a>
              </li>
              <li>
                <a
              ...
              <li>
                <a href="/booking">{lang === "ru" ? "Бронирование" : "Booking"}</a>
              </li>
            </ul>
          </div>
          <div className="fCol">
            <h4>{lang === "ru" ? "Связь" : "Connect"}</h4>
            <ul className="fSocials">
              ...
              <li>
                <a href="tel:+79631630066" className="soc phone">
                  +7 (963) 163-00-66
                </a>
              </li>
            </ul>
      ...
      <div className="footerBottom">
        <div className="footerWrap">
          <div className="copy">
            <span className="copyBrand">© {year} SHOW SOCHI</span>
